...
║  │  • Provides Fiori Launchpad  (/cp.portal)                                │   ║
...
║  │  │  • Discount logic           │  │  • Requires @restrict admin     │    │   ║
║  │  │  • submitOrder action       │  │                                 │    │   ║
║  │  └─────────────────────────────┘  └─────────────────────────────────┘    │   ║
║  │                                                                           │   ║
...
║  │  • HDI container manages schema  │  │  • Delegates authz to AMS             │ ║
║  │  • Artifacts deployed by         │  │    (authorization: enabled: true)     │ ║
║  │    superbooks-db-deployer        │  │  • MTLS credential binding            │ ║
║  └──────────────────────────────────┘  └───────────────┬──────────────────────┘ ║
║                                                         │ DCL policies           ║
║                                        ┌────────────────▼──────────────────────┐ ║
║                                        │  SAP Authorization Mgmt Service (AMS) │ ║
║                                        │  (built into IAS, no separate svc)    │ ║
║                                        │                                        │ ║
║                                        │  • Evaluates DCL authorization rules  │ ║
║                                        │  • Policies pushed by                 │ ║
║                                        │    ams-policies-deployer (CF task)    │ ║
║                                        └───────────────────────────────────────┘ ║
║                                                                                   ║
╚═══════════════════════════════════════════════════════════════════════════════════╝
...
DCL         Data Control Language — AMS authorization policy files (compiled by cds build)
